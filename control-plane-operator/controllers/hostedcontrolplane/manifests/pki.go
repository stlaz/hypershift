...
func EtcdSignerSecret(ns string) *corev1.Secret { return secretFor(ns, "etcd-signer") }
...
func EtcdMetricsSignerSecret(ns string) *corev1.Secret { return secretFor(ns, "etcd-metrics-signer") }
